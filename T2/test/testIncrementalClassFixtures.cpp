...
class IncrementalClass2 : public ::testing::Test {
 protected:
...
TEST_F(IncrementalClass2, Incremental5Points) {
    Poligono<float> pol2 = Incremental(puntos1, 5);
    std::cout << pol2;
...
TEST_F(IncrementalClass2, Incremental22Points) {
    ...
    Poligono<float> pol3 = Incremental(puntos2, 22);
    std::cout << pol3;
